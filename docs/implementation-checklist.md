...
- [ ] **Instruction encodings**: Assembler/compiler use spec §2; [encoding-tables/integer-instructions.csv](../encoding-tables/integer-instructions.csv) and [encoding-tables/vector-instructions.csv](../encoding-tables/vector-instructions.csv) for reference (spec is authoritative).
